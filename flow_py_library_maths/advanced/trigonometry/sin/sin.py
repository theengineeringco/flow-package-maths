...
def process(component: Component):
    ...
    # sin
    res = math.sin(angle_val)

    # logs
    angle_val_deg = angle_val * 180 / math.pi
    component.log(log_level=LogLevel.DEBUG, message=f"sin({angle_val}rad or {angle_val_deg}°) gives {res}.")
