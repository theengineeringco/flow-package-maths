...
def process(component: Process):
    ...
    values = [float(component.get_data(inport_id)) for inport_id in inport_ids]
    result = reduce(lambda v1, v2: v1 - v2, values)
...
if __name__ == "__main__":
    ...
    setting_data = {"terms": 3}
    inports_data: Dict[str, FlowType] = {"value1": base.Double(5), "value2": base.Int(2), "value3": base.Int(3)}
